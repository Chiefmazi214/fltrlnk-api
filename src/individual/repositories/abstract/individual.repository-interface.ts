...
export interface IndividualRepositoryInterface extends BaseRepository<IndividualDocument> {
    ...
    findNearby(latitude: number, longitude: number, maxDistance: number, page: number, limit: number, searchQuery?: string, lifestyleCategories?: string[]): Promise<PaginatedResultDto<Individual>>;
