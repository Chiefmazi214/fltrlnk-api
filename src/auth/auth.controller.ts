...
export class AuthController {
    ...
    @ApiResponse({ status: 401, description: 'Unauthorized' })
    @HttpCode(HttpStatus.OK)
    sendEmailVerificationOtp(@Body() sendEmailVerificationOtpDto: SendEmailCodeDto) {
        return this.authService.sendEmailVerificationOtp(sendEmailVerificationOtpDto.email);
    }
    ...
    @ApiResponse({ status: 401, description: 'Unauthorized' })
    @HttpCode(HttpStatus.OK)
    sendPhoneVerificationOtp(@Body() sendPhoneVerificationOtpDto: SendPhoneCodeDto) {
        return this.authService.sendPhoneVerificationOtp(sendPhoneVerificationOtpDto.phone);
    }
    ...
    sendForgetPasswordOtp(@Body() sendForgetPasswordOtpDto: ForgetPasswordDto) {
        return this.authService.sendForgetPasswordOtp(sendForgetPasswordOtpDto.email, sendForgetPasswordOtpDto.phone);
    }
